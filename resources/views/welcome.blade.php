...
<head>
  ...
  <title>3rd INDONESIAN GEOTHERMAL FESTIVAL</title>
    ...
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(images/slider/1.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">The <span>3<sup>rd</sup></span> Indonesian</h1>
            <h1 class="animated fadeInRightBig"><span>geothermal</span> Festival</h1>
            <p class="animated fadeInRightBig">Expo - photo contest - kids contest - Innovation Challenge</p>
            <p class="animated fadeInLeftBig">Educative fun trip - talk show - cultural night</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>
          </div>
        </div>
        <div class="item" style="background-image: url(images/slider/2.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">COMING SOON</h1>
            <h1 class="animated fadeInRightBig">on <span>JULY 2017</span></h1>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>
          </div>
        </div>
        <div class="item" style="background-image: url(images/slider/3.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">Presented <span>by</span></h1>
            <h1 class="animated fadeInRightBig">KKN-PPM UGM 2017</h1>
            <h1 class="animated fadeInLeftBig"><span>SLU-07 & SLU-08</span></h1>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="scroll"><a href="#journey">Jadwal</a></li>
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="about-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
            <h2>Tentang Indonesian Geothermal Festival</h2>
            ...
            <div class="post-thumb">
              <div id="post-carousel"  class="carousel slide" data-ride="carousel">
                <ol class="carousel-indicators">
                  ...
                  <li data-target="#post-carousel" class="" data-slide-to="1"></li>
